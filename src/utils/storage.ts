...
export const DEFAULT_CATEGORIES: Category[] = [
  {
    id: 'cat_household_kirana',
    name: 'Household & Kirana',
    type: 'expense',
    icon: 'home',
    color: '#3B82F6',
    subcategories: [
      { id: 'sub_vegetables', name: 'Vegetables & Sabzi', color: '#3B82F6', icon: 'local-florist' },
      { id: 'sub_kirana', name: 'Kirana & Groceries', color: '#3B82F6', icon: 'shopping-cart' },
      { id: 'sub_milk', name: 'Milk & Dairy', color: '#3B82F6', icon: 'local-cafe' },
      { id: 'sub_maid', name: 'Maid & Housekeeping', color: '#3B82F6', icon: 'cleaning-services' },
      { id: 'sub_cook', name: 'Cook & Household Help', color: '#3B82F6', icon: 'face' },
      { id: 'sub_lpg', name: 'LPG Gas Cylinder', color: '#3B82F6', icon: 'local-fire-department' },
      { id: 'sub_rent', name: 'Rent / PG Fee', color: '#3B82F6', icon: 'home' },
      { id: 'sub_electricity', name: 'Electricity Bill', color: '#3B82F6', icon: 'electrical-services' },
      { id: 'sub_water', name: 'Water Supply / Tanker', color: '#3B82F6', icon: 'water-drop' },
      { id: 'sub_wifi', name: 'WiFi & Broadband', color: '#3B82F6', icon: 'wifi' },
      { id: 'sub_society', name: 'Society Maintenance', color: '#3B82F6', icon: 'apartment' },
    ]
  },
  {
    id: 'cat_vehicle_commute',
    name: 'Vehicle & Commute',
    type: 'expense',
    icon: 'directions-car',
    color: '#06B6D4',
    subcategories: [
      { id: 'sub_petrol', name: 'Petrol & Fuel', color: '#06B6D4', icon: 'local-gas-station' },
      { id: 'sub_bike_repair', name: 'Bike Repair & Service', color: '#06B6D4', icon: 'two-wheeler' },
      { id: 'sub_car_repair', name: 'Car Repair & Service', color: '#06B6D4', icon: 'build' },
      { id: 'sub_auto_cab', name: 'Auto / Taxi / Uber', color: '#06B6D4', icon: 'local-taxi' },
      { id: 'sub_metro_bus', name: 'Metro & Bus Pass', color: '#06B6D4', icon: 'directions-bus' },
      { id: 'sub_fastag', name: 'Fastag & Tolls', color: '#06B6D4', icon: 'confirmation-number' },
      { id: 'sub_parking', name: 'Parking Charges', color: '#06B6D4', icon: 'local-parking' },
      { id: 'sub_vehicle_ins', name: 'Vehicle Insurance', color: '#06B6D4', icon: 'shield' },
    ]
  },
  {
    id: 'cat_food_dining',
    ...
    color: '#F59E0B',
    subcategories: [
      { id: 'sub_swiggy', name: 'Swiggy & Zomato', color: '#F59E0B', icon: 'delivery-dining' },
      { id: 'sub_restaurants', name: 'Restaurants & Outings', color: '#F59E0B', icon: 'restaurant' },
      { id: 'sub_chai_snacks', name: 'Chai & Street Food', color: '#F59E0B', icon: 'local-cafe' },
      { id: 'sub_sweets', name: 'Sweets & Bakery', color: '#F59E0B', icon: 'cake' },
    ]
  },
  {
    id: 'cat_shopping_lifestyle',
    name: 'Shopping & Lifestyle',
    type: 'expense',
    icon: 'shopping-bag',
    color: '#EC4899',
    subcategories: [
      { id: 'sub_online_shopping', name: 'Amazon & Flipkart', color: '#EC4899', icon: 'shopping-bag' },
      { id: 'sub_clothes', name: 'Clothes & Festive Wear', color: '#EC4899', icon: 'checkroom' },
      { id: 'sub_footwear', name: 'Footwear & Shoes', color: '#EC4899', icon: 'storefront' },
      { id: 'sub_salon', name: 'Salon & Parlour', color: '#EC4899', icon: 'content-cut' },
      { id: 'sub_gadgets', name: 'Electronics & Gadgets', color: '#EC4899', icon: 'phone-android' },
    ]
  },
  {
    id: 'cat_bills_emis',
    ...
    color: '#8B5CF6',
    subcategories: [
      { id: 'sub_recharge', name: 'Mobile Recharge (Jio/Airtel)', color: '#8B5CF6', icon: 'phone-iphone' },
      { id: 'sub_emi', name: 'Loan EMI & Credit Card', color: '#8B5CF6', icon: 'credit-card' },
      { id: 'sub_ott', name: 'OTT & Subscriptions', color: '#8B5CF6', icon: 'subscriptions' },
      { id: 'sub_dth', name: 'DTH & Cable TV', color: '#8B5CF6', icon: 'tv' },
    ]
  },
  {
    ...
    color: '#10B981',
    subcategories: [
      { id: 'sub_pharmacy', name: 'Pharmacy & Medicine', color: '#10B981', icon: 'medical-services' },
      { id: 'sub_doctor', name: 'Doctor & Lab Tests', color: '#10B981', icon: 'local-hospital' },
      { id: 'sub_gym', name: 'Gym & Yoga', color: '#10B981', icon: 'fitness-center' },
      { id: 'sub_health_ins', name: 'Health Insurance', color: '#10B981', icon: 'shield' },
    ]
  },
  {
    id: 'cat_income_earnings',
    name: 'Income & Salary',
    type: 'income',
    icon: 'monetization-on',
    color: '#10B981',
    subcategories: [
      { id: 'sub_salary', name: 'Monthly Salary', color: '#10B981', icon: 'work' },
      { id: 'sub_bonus', name: 'Bonus & Incentive', color: '#10B981', icon: 'card-giftcard' },
      { id: 'sub_freelance', name: 'Freelance & Side Gig', color: '#10B981', icon: 'laptop' },
      { id: 'sub_business', name: 'Business Profits', color: '#10B981', icon: 'storefront' },
      { id: 'sub_rental', name: 'Rental Income', color: '#10B981', icon: 'home' },
      { id: 'sub_cashback', name: 'Cashback & Refunds', color: '#10B981', icon: 'savings' },
    ]
  }
];
